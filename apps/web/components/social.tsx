...
const social = [
  {
    icon: GitHubIcon,
    label: "Github",
    url: "https://github.com/PunGrumpy/pigo",
  },
];
    ...
    {social.map((item) => (
      <a
        ...
        className={cn(
          ...
          "[&_svg_path]:transition-[fill] transition-[background,border-color] duration-200 hover:bg-gray-300 hover:border-gray-300 hover:[&_svg_path]:fill-gray-1000",
